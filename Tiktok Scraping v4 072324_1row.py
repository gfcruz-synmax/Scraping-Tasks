...
nonvideocol=["Username","Full Name","Following Count","Followers Count","Likes Count","Bio","Bio Link/s","Video URLs"]
...
#Create a list of only the useful non-video information for ease of tabulation
nonvideo=[title, subtitle, following_count, followers_count, likes_count, user_bio, user_link, video_urls]
